...
C {devices/iopin.sym} 1130 -840 0 0 {name=p2 lab=drv<1>}
C {devices/iopin.sym} 970 -840 0 0 {name=p3 lab=drv<2>}
C {devices/iopin.sym} 800 -840 0 0 {name=p4 lab=drv<3>}
C {devices/iopin.sym} 640 -840 0 0 {name=p5 lab=drv<4>
}
C {devices/iopin.sym} 470 -840 0 0 {name=p6 lab=drv<5>
}
C {devices/iopin.sym} 290 -840 0 0 {name=p7 lab=drv<6>
}
C {devices/iopin.sym} 1300 -660 0 0 {name=p8 lab=tah<0>
}
C {devices/iopin.sym} 1130 -660 0 0 {name=p9 lab=tah<1>
}
C {devices/iopin.sym} 970 -660 0 0 {name=p10 lab=tah<2>
}
C {devices/iopin.sym} 800 -660 0 0 {name=p11 lab=tah<3>
}
C {devices/iopin.sym} 640 -660 0 0 {name=p12 lab=tah<4>
}
C {devices/iopin.sym} 470 -660 0 0 {name=p13 lab=tah<5>
}
C {devices/iopin.sym} 290 -660 0 0 {name=p14 lab=tah<6>}
