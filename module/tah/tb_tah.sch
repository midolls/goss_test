...
N -20 20 -20 50 {
lab=vin}
C {/foss/designs/goss_test/module/tah.sym} 120 0 0 0 {name=x1}
...
C {devices/vsource.sym} -70 130 0 0 {name=V5 value="sin(0.9 0.9 2MEG 48n)"
}
...
C {devices/vsource.sym} -20 80 0 0 {name=V6 value="sin(0.9 0.9 2MEG 0)"
}
