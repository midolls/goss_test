...
C {/foss/designs/goss_test/module/jh_top/jh_top.sym} 1040 -370 0 0 {name=x4}
...
C {devices/lab_pin.sym} 1190 -360 2 0 {name=p28 sig_type=std_logic lab=tempD[0:8]}
...
C {devices/vsource.sym} 1560 -220 3 0 {name=V6 value=0}
C {devices/gnd.sym} 1590 -220 0 0 {name=l1 lab=GND}
C {devices/vsource.sym} 1560 -250 3 0 {name=V7 value=0}
